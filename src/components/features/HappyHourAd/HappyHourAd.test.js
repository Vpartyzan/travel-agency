...
describe('Component HappyHourAd', () => {
  ...
  it('should title has content from props', () => {
...
const checkDescriptionAfterTime = ( time, delaySeconds, expectDescription ) => {
...
describe('Component HappyHourAd with promo information', () => {
